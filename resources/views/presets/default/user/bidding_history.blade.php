                    ...
                    <tbody>
                        @forelse ($bids as $bid)
                            <tr>
                                ...
                                <td data-label="Product Name">{{ @$bid->product->title }}</td>
                                <td data-label="Product Price">{{ showAmount(@$bid->product->price,2) }}</td>
                                <td data-label="Bid Price">{{ showAmount(@$bid->price, 2) }}</td>
                                ...
                                <td data-label="View">
                                    <div class="button--group">
                                        <a title="@lang('Details')" href="javascript:void(0)" class="btn btn--sm btn--base detailsBtn border-none" data-owner="{{ $bid->product->user ? $bid->product->user->fullname : 'Administrator' }}" data-title="{{$bid->product->title}}" data-price="{{ showAmount($bid->product->price,2) }}" data-product="{{$bid->product}}" data-time="{{showDateTime($bid->created_at, 'd M, Y H:s:ia')}}">
