                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two custom-data-table white-space-wrap" id="myTable">
                            ...
                            <tbody>
                                <tr>
                                    <td class="white-space-wrap">{{$list_lang['key']}}</td>
                                    <td class="text-left white-space-wrap">{{$list_lang['value']}}</td>


                                    <td>
                                        <a title="@lang('Edit')" href="javascript:void(0)" data-bs-target="#editModal"
                                            data-bs-toggle="modal" data-title="{{$list_lang['key']}}" data-key="{{$list_lang['key']}}"
                                            data-value="{{$list_lang['value']}}" class="editModal btn btn-sm btn--primary">
                                            <i class="la la-pencil"></i>
                                        </a>

                                        <a title="@lang('Remove')" href="javascript:void(0)" data-key="{{$list_lang['key']}}"
                                            data-value="{{$list_lang['value']}}" data-bs-toggle="modal" data-bs-target="#DelModal"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.language.store.key',$list_lang['id'])}}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.language.update.key',$list_lang['id'])}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group ">
    ...
    <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="DelModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.language.delete.key',$list_lang['id'])}}" method="post">
                    @csrf
                    <input type="hidden" name="key">
