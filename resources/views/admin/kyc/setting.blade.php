...
<div class="row mb-none-30">
    <div class="col-lg-12">
        <div class="card">
            <div class="d-flex justify-content-between aligh-item-center">
                <h5 class="text-dark mx-3 mt-2">@lang('KYC Form for User')</h5>
                <button type="button" class="mx-3 mt-2 btn btn-sm btn--primary btn-outline-light float-end form-generate-btn"> <i
                            ...
                            <div class="card border mb-3" id="{{ $loop->index }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group text-end">
                                        <button type="button" class="btn btn--primary editFormData me-1" data-form_item="{{ $jsonData }}" data-update_id="{{ $loop->index }}"><i class="las la-pen"></i></button>
