    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function(){
                ...
                // Bid History
                Route::get('bidding/history', 'biddingHistory')->name('bidding.history');

                // Winning History
                Route::get('winninging/history', 'winningHistory')->name('winning.history');
            ...
            // Auction
            Route::middleware('kyc')->controller('ProductController')->name('product.')->prefix('auctions')->group(function(){
                ...
                Route::get('{id}/bids', 'productBids')->name('bidder.list');
